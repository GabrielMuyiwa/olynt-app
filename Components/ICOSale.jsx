        ...
        <div className="modal-content">
          <div className="modal__content">
            ...
            <h4 className="modal__title">
              {tokenDetails?.token.symbol} Token Offering
            </h4>
            <p className="modal__text">
              Participate in the <span>Ongoing Token Offering</span> and Be Part of GrainFi's Future!
            </p>
